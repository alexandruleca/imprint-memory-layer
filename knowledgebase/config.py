...
MODEL_NAME = os.environ.get("KNOWLEDGE_MODEL_NAME", "Xenova/bge-m3")
...
# the fp16 model file unless the user pinned one via KNOWLEDGE_MODEL_FILE.
DEVICE = os.environ.get("KNOWLEDGE_DEVICE", "auto").lower()
...
MODEL_FILE = os.environ.get("KNOWLEDGE_MODEL_FILE", _default_model_file())
EMBEDDING_DIM = int(os.environ.get("KNOWLEDGE_EMBEDDING_DIM", "1024"))
...
MAX_SEQ_LENGTH = int(os.environ.get("KNOWLEDGE_MAX_SEQ_LENGTH", "2048"))

# ── Qdrant ──────────────────────────────────────────────────────
QDRANT_COLLECTION = os.environ.get("KNOWLEDGE_COLLECTION", "memories")
...
CHUNK_OVERLAP = int(os.environ.get("KNOWLEDGE_CHUNK_OVERLAP", "150"))
...
CHUNK_SIZE_CODE = int(os.environ.get("KNOWLEDGE_CHUNK_SIZE_CODE", "800"))
CHUNK_SIZE_PROSE = int(os.environ.get("KNOWLEDGE_CHUNK_SIZE_PROSE", "1500"))
# Legacy alias — some callers may still import CHUNK_SIZE_CHARS.
CHUNK_SIZE_CHARS = int(os.environ.get("KNOWLEDGE_CHUNK_SIZE", str(CHUNK_SIZE_PROSE)))

CHUNK_HARD_MAX = int(os.environ.get("KNOWLEDGE_CHUNK_HARD_MAX", "6000"))
...
CHUNK_SEMANTIC_THRESHOLD = float(os.environ.get("KNOWLEDGE_SEMANTIC_THRESHOLD", "0.5"))
